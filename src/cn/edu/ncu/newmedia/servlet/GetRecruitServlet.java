...
public class GetRecruitServlet extends javax.servlet.http.HttpServlet {
    ...
    protected void doGet(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, IOException {
         ...
         */
        long communityId = Long.parseLong(request.getParameter("ucommunityId"));
...
//        		communityId = Integer.parseInt(communityIdStr);
        	...
        	if(recruitDao.gettotal(communityId)>uid)
        		recruit = recruitDao.get_one(uid,communityId);
        	/*
        	 * 将获得的学生信息转成json格式
        	 */
            ...
            out.print(recruit.getId());
            out.print(recruitStr);
            /*
             * 若通过一轮审核，则调用passone()方法，将状态改为1，并将发送信息状态改为..
             * 若没通过审核，则不做操作
             */
            if(request.getParameter("shenhe")=="true") {
